...
| **L2** | High | 重大な機能障害 | 1時間以内 | テックリード + 担当者 |
| **L3** | Medium | 部分的な機能障害 | 4時間以内 | 担当開発者 |
| **L4** | Low | 軽微な問題 | 翌営業日 | 担当開発者 |
...
| 役職 | 担当範囲 | 連絡方法 | 対応可能時間 |
|------|----------|----------|-------------|
| **管理責任者** | 全体統括 | SAS Github管理チーム | 24時間 |
| **技術責任者** | 技術対応 | github@sas-com.com | 24時間 |
| **セキュリティ責任者** | セキュリティ | github@sas-com.com | 24時間 |
| **プロジェクトマネージャー** | クライアント対応 | 各担当PM | 営業時間内 |
...
| **セキュリティベンダー** | インシデント対応 | 契約ベンダー連絡先 | 24時間対応 |
