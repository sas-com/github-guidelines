...
| 項目 | 内容 |
|------|------|
| **目的** | バージョン管理システムGitをWSL2環境にインストールし、ソースコードの変更履歴管理、チーム開発、バージョン管理を可能にする基盤を構築。GitHubユーザー名との統一、会社標準ドメインの設定、日本語対応、改行コード設定等、SAS開発標準に準拠した初期設定を実施します。 |
| **所要時間** | 10-15分 |
| **難易度** | ★☆☆ |
| **前提条件** | WSL2完了 |
...
**標準構成（全員必須）：**
1. **メイン認証**: 認証アプリ（Google Authenticator / Microsoft Authenticator / Authy）
